...
async def handle_owner_media(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Broadcast uchun media qabul qilish
    if action == "broadcast":
        ...
        await update.message.reply_text("Media qabul qilindi! Broadcastni boshlash uchun 'HA' yozing yoki bekor qilish uchun boshqa narsa yozing.")
        return
...
app.add_handler(MessageHandler(filters.VIDEO, handle_owner_media))
app.add_handler(MessageHandler(filters.PHOTO, handle_owner_media))
