...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "upload_video":
        ...
        await query.message.reply_text("Broadcast xabarni yozing:")
        return
        ...
        await update.callback_query.message.reply_text("Matnni yozing, u barcha videolarga qo‘shiladi:")
        return
        ...
        if films:
            ...
            await update.callback_query.message.reply_text("Hali videolar yo‘q.")
        return

    elif data == "delete_extra":
        context.user_data["action"] = "delete_extra"
        await update.callback_query.message.reply_text("Matnni o‘chirish uchun video kodini yozing (barcha videolardan o‘chadi):")
        return
        ...
        await update.callback_query.message.reply_text(f"Yangi kodni yozing (eski kod: {old_code}):")
        return
        ...
        conn.commit()
        await update.callback_query.message.reply_text(f"Video {code} o‘chirildi!")
        return
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id == OWNER_ID:
        ...
        if action == "update_code":
            ...
            conn.commit()
            await update.message.reply_text(f"Video kodi {old_code} dan {text} ga o‘zgartirildi!")
            context.user_data.clear()
            return
