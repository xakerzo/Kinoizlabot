...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "upload_video":
        ...
        await query.message.reply_text("Broadcast uchun matn yoki media yuboring:")
        return
...
async def handle_owner_video(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "broadcast":
        ...
        await update.message.reply_text("Video qabul qilindi, endi matnni yuboring yoki broadcastni boshlang:")
        return
...
async def handle_owner_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.user_data.get("action") == "broadcast":
        ...
        if update.message.caption:
            context.user_data["broadcast_text"] = update.message.caption
        await update.message.reply_text("Rasm qabul qilindi, endi matnni yuboring yoki broadcastni boshlang:")
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id == OWNER_ID:
        ...
        # Qo‘shimcha matn va boshqa owner actionlar shu yerda saqlanadi...
        # Siz ilgari yozgan barcha owner actionlar shu yerda ishlaydi (add_extra, delete_extra, update_code, add_channel, delete_channel, search_video)
