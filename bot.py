...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id == OWNER_ID:
        ...
        # Qolgan owner actionlar: search, add/delete channel, extra text, update code
        # Shu yerga oldingi kodingizdagi handle_text qismi qoladi
        # ...

    # ---------- FOYDALANUVCHI KINO KO‘RISH ----------
    # Shu qism ham oldingi kodingizdagi handle_text qismi bilan qoladi
